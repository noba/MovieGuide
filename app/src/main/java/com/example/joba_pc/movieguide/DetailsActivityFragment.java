...
import com.example.joba_pc.movieguide.DataAdapter.ReviewAdapter;
import com.example.joba_pc.movieguide.DataAdapter.TrailerAdapter;
import com.example.joba_pc.movieguide.DataModel.Movie;
import com.example.joba_pc.movieguide.DataModel.Review;
import com.example.joba_pc.movieguide.DataModel.Trailer;
        ...
        protected List<Trailer> doInBackground(String... params) {
            ...
            try {
                ...
                Uri builtUri = Uri.parse(BASE_URL).buildUpon()
                        .appendQueryParameter(API_KEY_PARAM, "4020dbfdeb6ffe7ecbe79e6317cf3aba")
                        .build();
